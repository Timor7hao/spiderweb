    ...
    <div id="SeeDetails">
        ...
        <el-card class="box-card">
            ...
            <el-form class="demo-dynamic">
                ...
                <el-col :span="5">
                    <el-form-item label="Spider：" prop="num">
                        <el-select v-model="value2" @change="selectGet2" placeholder="Please select a Spider" empty-text="NO DATA">
                            <el-option label="UserInfo" value="userinfo"></el-option>
                            <el-option label="Friends" value="friends"></el-option>
                            <el-option label="TimeLine" value="content"></el-option>
...
<script>
import ResultUserinfo from '@/components/FaceBook/tables/ResultUserinfo'
import ResultFriends from '@/components/FaceBook/tables/ResultFriends'
import ResultContent from '@/components/FaceBook/tables/ResultContent'
import ResultComments from '@/components/FaceBook/tables/ResultComments'
import ResultLike from '@/components/FaceBook/tables/ResultLike'
export default {
    name: 'SeeDetails',
    components: {
        'userinfo': ResultUserinfo,
        'friends': ResultFriends,
        'content2': ResultContent,
    ...
    data() {
        return {
            ...
            tableData2: [],   //friends的表
            tableData3: [],   //content的表
            tableData4: [],   //comments的表
            tableData5: [],    //like的表
            jobid:''      //供传到后面来查值
        }
    },
    ...
    methods: {
        ...
        getTaskIDList(){
            ...
            this.$ajax({
                ...
                for(var i=0;i<res.data.data.length;i++)
                {
                    if(res.data.data[i]!="facebook_account"&&res.data.data[i]!="facebook_history")
                    {
                        var model = res.data.data[i];
                        var item = {};
                        item.id =  model;
