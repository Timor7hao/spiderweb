<template>
    <div id="ResultTable2">
        <h2>Like-Section</h2>
        <el-table id="Data5" :data="Data5.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe style="width: 100%" height="600" border empty-text="NO DATA">
        ...
        <el-table id="Data5All" :data="Data5All" stripe style="width: 100%" height="600" border empty-text="NO DATA" hidden>
            <el-table-column prop="#" label="#" width="50" type="index" fixed></el-table-column>
            <el-table-column prop="user_id" label="user_id" width="180" fixed></el-table-column>
            <el-table-column prop="post_id" label="post_id" width="180"></el-table-column>
            <el-table-column label="avatar" width="150">
...
export default {
    ...
    watch:{
        ...
        this.$nextTick( function(){
            this.Data5_jsondata = this.message
            this.Data5 = this.message
            this.Data5All = this.message
    ...
    methods: {
        ...
        //输出JSON格式数据下载
        Export1() {
            var blob = new Blob([JSON.stringify(this.Data5_jsondata, null, 2)],{type:'application/json,charset=utf-8;'});
            saveAs(blob, "like_result" + '.json');
        },
        //输出CSV格式数据下载
        Export2() {
            var fix = document.querySelector('.el-table__fixed');
            let table = document.querySelector("#Data5All").cloneNode(true);
            if(fix)
            ...
            try {
                FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'like_result.csv')
            } catch (e) { 
        ...
        Export3() {
            ...
            try {
                FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'like_result.xlsx')
            } catch (e) { 
                if (typeof console !== 'undefined') console.log(e, wbout) 
            }
        }
