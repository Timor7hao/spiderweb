<template>
    <div id="ResultTable4">
        ...
        <el-table id="Data3" :data="Data3.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe style="width: 100%" height="600" border empty-text="NO DATA">
        ...
        <el-table id="Data3All" :data="Data3All" stripe style="width: 100%" height="600" border empty-text="NO DATA" hidden>
            <el-table-column prop="#" label="#" width="50" type="index" fixed></el-table-column>
            <el-table-column prop="user_id" label="user_id" width="180" fixed></el-table-column>
            <el-table-column prop="screen_name" label="screen_name" width="180"></el-table-column>
            <el-table-column label="avatar" width="150">
...
export default {
    ...
    methods: {
        ...
        Export1() {
            ...
            saveAs(blob, "content_result" + '.json');
        },
        //输出CSV格式数据下载
        Export2() {
            ...
            try {
                FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'content_result.csv')
            } catch (e) { 
        ...
        Export3() {
            ...
            try {
                FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'content_result.xlsx')
            } catch (e) { 
                if (typeof console !== 'undefined') console.log(e, wbout) 
            }
        }
