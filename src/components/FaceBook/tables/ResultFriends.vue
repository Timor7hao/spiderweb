<template>
    <div id="ResultTable3">
        ...
        <el-table id="Data2" :data="Data2.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe style="width: 100%" height="600" border empty-text="NO DATA">
        ...
        <el-table id="Data2All" :data="Data2All" stripe style="width: 100%" height="600" border empty-text="NO DATA" hidden>
            <el-table-column prop="#" label="#" width="50" type="index" fixed></el-table-column>
            <el-table-column prop="user_id" label="user_id" width="180" fixed></el-table-column>
            <el-table-column prop="screen_name" label="screen_name" width="200"></el-table-column>
            <el-table-column label="avatar" width="150">
