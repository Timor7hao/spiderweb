<template>
    <div id="ResultTable1">
        ...
        <el-table id="Data1" :data="Data1.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe style="width: 100%" height="600" border empty-text="NO DATA">
        ...
        <el-table id="Data1All" :data="Data1All" stripe style="width: 100%" height="600" border empty-text="NO DATA" hidden>
            <el-table-column prop="#" label="#" width="50" type="index" fixed></el-table-column>
            <el-table-column prop="user_id" label="user_id" width="180" fixed></el-table-column>
            <el-table-column prop="name" label="name" width="120"></el-table-column>
            <el-table-column label="avatar" width="150">
