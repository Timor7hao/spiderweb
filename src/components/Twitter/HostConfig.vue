        ...
        <el-card class="box-card">
            ...
            <div class="a">
                <el-table :data="tableData1" :header-cell-style="tableHeaderColor" empty-text="NO DATA" max-width="982px">
                    ...
                    <el-table-column prop="status" label="HostStatus" width="220" align="center">
                    ...
                    <el-table-column prop="method" label="Operating" width="120" align="center">
                        <template slot-scope="props">
                            <el-button
