    ...
    <div id="UserConfig">
        ...
        <el-card class="box-card">
            ...
            <el-table :data="tableData1" :header-cell-style="tableHeaderColor" empty-text="NO DATA">
                <el-table-column prop="number" label="Number" width="80" align="center" type="index"></el-table-column>
                <el-table-column prop="user" label="Account" width="200" align="center"></el-table-column>
                <el-table-column prop="password" label="Password" width="120" align="center"></el-table-column>
            ...
            <div class="button2">
                ...
                <el-dialog title="AddAccount" :visible.sync="dialogFormVisible" center style="margin-top:90px;width:1200px;margin:0 auto">
                    ...
                    <div slot="footer" class="dialog-footer" style="height: 65px;">
                        <el-button class="ripple" @click="dialogFormVisible = false; resetForm('ruleForm2')" style="margin-top:0px;margin-right:85px;">Cancel</el-button>
...
export default {
    ...
    refreshCookieRow(){
        ...
        this.$ajax({
            ...
            if(res.data.data == "Online")
            {
                ...
                this.$ajax({
                    url: '/two/twitter/acc/updateOneCookie',
                    method: 'post',
                    contentType: "application/json; charset=utf-8",
                    data: Params2,
                }).then( res => {
    ...
    refreshAllCookieRow(){
        this.$confirm('Are you sure to refresh all Account\'s cookie?','NOTICE',{
            ...
            var Params = {}
            this.$ajax({
                url: '/two/twitter/acc/updateAllCookie',
                method: 'get',
                contentType: "application/json; charset=utf-8",
                data: Params,
            }).then( res => {
