...
export default {
    ...
    methods: {
        ...
        Export1() {
            ...
            saveAs(blob, "follow_result" + '.json');
        },
        //输出CSV格式数据下载
        Export2() {
            ...
            try {
                FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'follow_result.csv')
            } catch (e) { 
        ...
        Export3() {
            ...
            try {
                FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), 'follow_result.xlsx')
            } catch (e) { 
                if (typeof console !== 'undefined') console.log(e, wbout) 
            }
        }
