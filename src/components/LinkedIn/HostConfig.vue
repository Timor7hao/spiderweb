                ...
                <el-dialog title="AddHost" :visible.sync="dialogFormVisible" center style="margin-top:90px;width:1200px;margin:0 auto">
                    <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
                        <el-form-item prop="name" label="Name：">
                            <el-input ref="name" v-model.number="ruleForm2.name" style="width:90%" placeholder="Optional fill"></el-input>
                        </el-form-item>
...
export default {
    ...
    deleteRow(row){
        this.$confirm('Are you sure to delete this host?','NOTICE',{
            ...
            // console.log(Params)
            this.$ajax({
                url: '/three/linkedin/host/remove',
                method: 'post',
                contentType: "application/json; charset=utf-8",
                data: Params,
            }).then( res => {
