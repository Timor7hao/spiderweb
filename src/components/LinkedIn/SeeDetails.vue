...
<script>
import LKResultUserinfo from '@/components/LinkedIn/tables/ResultUserinfo'
import LKResultFriends from '@/components/LinkedIn/tables/ResultFriends'
import LKResultCompany from '@/components/LinkedIn/tables/ResultCompany'
export default {
    name: 'SeeDetails',
    components: {
        'userinfo': LKResultUserinfo,
        'friends': LKResultFriends,
        'company': LKResultCompany,
    },
    data() {
        return {
            nowModel: 'userinfo',
    ...
    methods: {
        ...
        getTaskIDList(){
            ...
            this.$ajax({
                ...
                {
                    if(res.data.data[i]!="linkedin_history"&&res.data.data[i]!="linkedin_account")
                    {
        ...
        SearchList() {
            ...
            //     }   
                ...
                this.$ajax({
                    url: '/three/linkedin/db/queryAll',
                    method: 'get',
                    contentType: "application/json; charset=utf-8",
                    params: Params2
                }).then( res => {
